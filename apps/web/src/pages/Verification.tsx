        ...
        {!isVerified ? (
          <>
            ...
            <form onSubmit={handleVerify} className="space-y-8">
              <div className="flex justify-center gap-2 md:gap-3">
                {code.map((digit, index) => (
                  <input
                    key={index}
                    // Updated ref assignment to return void
            ...
            <div className="mt-8 text-center">
              ...
              <button className="inline-flex items-center gap-2 text-[#05668A] font-bold hover:text-[#EF8D8E] transition-colors text-sm group">
