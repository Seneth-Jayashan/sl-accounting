...
const AdminKnowledgeBase: React.FC = () => {
  ...
  return (
      <div className="max-w-3xl mx-auto p-4 sm:p-6 space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Upload Material</h1>
        ...
        >
          ...
          <div className="flex flex-col-reverse sm:flex-row gap-3 pt-4 border-t border-gray-100">
            <button
              type="button"
              onClick={() => navigate(-1)}
              className="w-full sm:flex-1 px-5 py-2 rounded-xl border border-gray-300 text-[#0A5B70]"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={loading}
              className="w-full sm:flex-1 px-5 py-2 rounded-xl bg-[#0A5B70] text-white font-medium disabled:opacity-60"
            >
