...
const CreateQuiz: React.FC = () => {
  ...
  const [quizData, setQuizData] = useState<QuizPayload>({
    title: "",
    description: "",
    class: "", // Will be filled from dropdown
    duration: 60,
    quizType: "live",
      ...
      <form onSubmit={handleSubmit} className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8 sticky top-0 bg-gray-50 z-10 py-4 border-b border-gray-200">
          <div>
            ...
            <p className="text-gray-500 text-sm">Design your SL Accounting assessment</p>
          </div>
                  ...
                  >
                    ...
                    {availableClasses.map((cls) => (
                      <option key={cls._id} value={cls._id}>
                        {cls.name} {cls.batch ? `(${typeof cls.batch === 'string' ? cls.batch : cls.batch.name})` : ''} - {cls.type}
                      </option>
                    ))}
                  </select>
                </div>
