...
const formatTime = (isoString: string) => {
  ...
  return (
      <div className="space-y-6 pb-20 sm:pb-0 font-sans"> 
            ...
            {loading ? (
                ...
                <>
                    ...
                    <StatCard 
                        ...
                        icon={DollarSign} 
                        colorClass={(data?.stats.pendingPaymentsCount ?? 0) > 0 ? "bg-red-500" : "bg-brand-cerulean"}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                    ...
                                    <div className="w-full sm:w-auto">
                                        {session.isOnline ? (
                                            <Link 
                                                ...
                                                className="flex items-center justify-center gap-3 w-full sm:w-auto px-6 py-3 bg-[#0A5B70] text-white text-sm font-bold rounded-xl hover:bg-brand-prussian transition-all active:scale-95">
                                                <Video size={27} /> View Class
                                            </Link>
                                        ) : (
                                            <div className="flex items-center justify-center gap-3 w-full sm:w-auto px-6 py-3 bg-gray-100 text-gray-500 text-sm font-bold rounded-xl">
                                                <MapPin size={27} /> Offline
                                            </div>
                                        )}
                                    </div>
                                </div>
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                 <h3 className="font-bold text-lg text-gray-900 flex items-center gap-2">Quick Actions</h3>
        ...
        {/* --- ROW 2: RECENT MATERIALS + PAYMENT STATUS --- */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">

            {/* RECENT MATERIALS (2/3 width) */}
            <div className="lg:col-span-2 bg-white rounded-2xl p-5 sm:p-6 shadow-sm border border-gray-100">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="font-bold text-lg text-gray-900 flex items-center gap-2">
                         Recent Materials
            ...
            {/* PAYMENT STATUS (1/3 width) */}
            <div className="bg-[#044555] rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
